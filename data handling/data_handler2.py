...
for filename in glob.glob('C:/Users/stelz/Google Drive/Thesis_Stelios_Zouridakis/Files/meas_and_plots2/experiments/exp5b/MCP2*.hdf5'):
...
for filename in glob.glob('C:/Users/stelz/Google Drive/Thesis_Stelios_Zouridakis/Files/meas_and_plots2/experiments/exp5b/MLXAmb*.hdf5'):
...
#for filename in glob.glob('C:/Users/stelz/Google Drive/Thesis_Stelios_Zouridakis/Files/meas_and_plots2/experiments/exp12/MCP1*.hdf5'):
...
for filename in glob.glob('C:/Users/stelz/Google Drive/Thesis_Stelios_Zouridakis/Files/meas_and_plots2/experiments/exp5b/Thermal*.hdf5'):
...
plt.plot(timestamps5, data2, label="MCP2 Ambient")
plt.plot(timestamps5, data5, label="Thermal Camera MAX")
plt.plot(timestamps5, data6, label="Thermal Camera MIN")
plt.plot(timestamps5, data3, label="MLX Object")
plt.plot(timestamps5, data4, label="MLX Ambient")
...
##plt.xlabel('Time on 2020-09-17 from 14:12:13 till 14:32:11') ##4a
##plt.xlabel('Time on 2020-09-17 from 14:46:10 till 15:06:08') ##4b
##plt.xlabel('Time on 2020-09-17 from 16:12:04 till 16:32:02') ##5a
plt.xlabel('Time on 2020-09-17 from 15:18:17 till 15:38:17') ##5b
plt.title('Experiment 5B\n\nChange of Object\'s Temperature Related to Ambient Temperature')
#plt.xlabel('Time')
